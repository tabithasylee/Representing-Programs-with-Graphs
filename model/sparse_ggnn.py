# Code obtained and modified from https://github.com/microsoft/dpu-utils/blob/master/python/dpu_utils/tfmodels/sparsegnn.py
# With some modificiations to get it to work with Tensorflow v2 and its compatibility features.
